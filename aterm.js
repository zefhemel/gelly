...
(function () {
    ...
    Term.prototype.toPrettyString = function(prefix) {
    ...
    ApplTerm.prototype.toString = function(prefix) {
      try {
        var s = this.cons + "(";
    ...
    ApplTerm.prototype.toPrettyString = function(prefix) {
      try {
        if(this.children.length === 0) {
        ...
        s += "\n";
        return s + prefix + ")" + annosToString(this.annos);
      } catch(e) {
        console.error("Something went wrong: ", this);
      }
    };
    ...
    ListTerm.prototype.toPrettyString = function(prefix) {
      try {
        if(this.children.length === 0) {
          return prefix + "[]";
        }
